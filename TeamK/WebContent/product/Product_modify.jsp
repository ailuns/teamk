 		...
 		<table>
			<tr>
				...
				<td>
					...
					<input id="name" style="display: none;" value="<%=pb_up.getName() %>"></input>
	
					<input type="text" id="up_color" value="<%=pb_up.getColor()%>" >
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" id="up_size" value="<%=pb_up.getSize() %>">
				</td>
			</tr>
