...
<body>
	<div id="wrap">
		...
		<article>
		<h1>회원가입</h1>
		<form action="./CategoryWriteAction.bo" method="POST" name="fr" id="join">
			<fieldset>
				<legend>카테고리 추가</legend>
				<label>카테고리명</label> <input type="type" name="caname"><br>
				<br>
					<label>카테고리</label>
					<td><select name="catype">
			...
			<div id="buttons">
				<input type="submit" value="회원가입" class="submit"> <input
					type="reset" value="다시작성" class="cancel">
			</div>
		</form>
		</article>
		<!-- 본문내용 -->
